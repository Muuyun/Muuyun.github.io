...
当人们谈论开发时，会聊到许多定律。 下面收录了一些最常见的定律。

> 包含对一些定律、原则以及模式的解释，但不提倡其中任何一个。 它们的应用始终存在着争论，并且很大程度上取决于你正在做什么。
...
![阿姆达尔定律](https://github.com/nusr/hacker-laws-zh/raw/master/images/amdahls_law.png)
...
- [KISS (Keep It Simple, Stupid)](https://github.com/nusr/hacker-laws-zh#TODO)
...
[![The Hype Cycle](https://github.com/nusr/hacker-laws-zh/raw/master/images/gartner_hype_cycle.png)](https://github.com/nusr/hacker-laws-zh/blob/master/images/gartner_hype_cycle.png)
...
这条定律通常用于说明半导体和芯片技术提高的绝对速度。从 20 世纪 70 年代到 21 世纪后期，摩尔的预测被证明是高度准确的。 近年来，这种趋势略有变化，部分原因受到[量子隧穿效应](https://zh.wikipedia.org/wiki/量子穿隧效應)影响。然而，并行化计算的进步以及半导体技术和量子计算潜在的革命性变化，可能意味着摩尔定律在未来几十年内继续保持正确。
...
> 转载自[**hacker-laws-zh**](https://github.com/nusr/hacker-laws-zh)
